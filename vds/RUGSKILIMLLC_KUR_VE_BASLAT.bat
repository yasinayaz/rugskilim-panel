@echo off
setlocal
title RugsKilimLLC - Kurulum ve Baslatici

echo =======================================================
echo   RugsKilimLLC - Otomatik Kurulum ve Baslatici
echo =======================================================
echo.
...
if not exist "C:\etsy_temp\RugsKilimLLC" mkdir "C:\etsy_temp\RugsKilimLLC"
echo [OK] Klasor hazir: C:\etsy_temp\RugsKilimLLC

if not exist "C:\etsy_temp\RugsKilimLLC_INDIR.bat" (
  (
    echo @echo off
    echo title RugsKilimLLC - Otomasyon
    echo call "C:\rugskilim-panel\vds\RUGSKILIMLLC_KUR_VE_BASLAT.bat"
  ) > "C:\etsy_temp\RugsKilimLLC_INDIR.bat"
  echo [OK] INDIR.bat olusturuldu: C:\etsy_temp\RugsKilimLLC_INDIR.bat
)

REM ── .env kontrol ─────────────────────────────────────────
if not exist "C:\rugskilim-panel\vds\.env" (
  copy "C:\rugskilim-panel\vds\RUGSKILIMLLC_env.txt" "C:\rugskilim-panel\vds\.env" >nul
...
set "TEMP_DIR=C:\etsy_temp\RugsKilimLLC"
