@echo off
setlocal
title WoolCottonRugs - Kurulum ve Baslatici

echo =======================================================
echo   WoolCottonRugs - Otomatik Kurulum ve Baslatici
echo =======================================================
echo.
...
if not exist "C:\etsy_temp\WoolCottonRugs" mkdir "C:\etsy_temp\WoolCottonRugs"
echo [OK] Klasor hazir: C:\etsy_temp\WoolCottonRugs

if not exist "C:\etsy_temp\WoolCottonRugs_INDIR.bat" (
  (
    echo @echo off
    echo title WoolCottonRugs - Otomasyon
    echo call "C:\rugskilim-panel\vds\WOOLCOTTONRUGS_KUR_VE_BASLAT.bat"
  ) > "C:\etsy_temp\WoolCottonRugs_INDIR.bat"
  echo [OK] INDIR.bat olusturuldu: C:\etsy_temp\WoolCottonRugs_INDIR.bat
)

REM ── .env kontrol ─────────────────────────────────────────
if not exist "C:\rugskilim-panel\vds\.env" (
  copy "C:\rugskilim-panel\vds\WOOLCOTTONRUGS_env.txt" "C:\rugskilim-panel\vds\.env" >nul
...
set "TEMP_DIR=C:\etsy_temp\WoolCottonRugs"
