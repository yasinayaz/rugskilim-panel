@echo off
setlocal
title OldNewRugs - Kurulum ve Baslatici

echo =======================================================
echo   OldNewRugs - Otomatik Kurulum ve Baslatici
echo =======================================================
echo.
...
if not exist "C:\etsy_temp\OldNewRugs" mkdir "C:\etsy_temp\OldNewRugs"
echo [OK] Klasor hazir: C:\etsy_temp\OldNewRugs

if not exist "C:\etsy_temp\OldNewRugs_INDIR.bat" (
  (
    echo @echo off
    echo title OldNewRugs - Otomasyon
    echo call "C:\rugskilim-panel\vds\OLDNEWRUGS_KUR_VE_BASLAT.bat"
  ) > "C:\etsy_temp\OldNewRugs_INDIR.bat"
  echo [OK] INDIR.bat olusturuldu: C:\etsy_temp\OldNewRugs_INDIR.bat
)

REM ── .env kontrol ─────────────────────────────────────────
if not exist "C:\rugskilim-panel\vds\.env" (
  copy "C:\rugskilim-panel\vds\OLDNEWRUGS_env.txt" "C:\rugskilim-panel\vds\.env" >nul
