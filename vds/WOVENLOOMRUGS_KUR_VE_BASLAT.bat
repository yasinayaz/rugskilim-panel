@echo off
setlocal
title WovenLoomRugs - Kurulum ve Baslatici

echo =======================================================
echo   WovenLoomRugs - Otomatik Kurulum ve Baslatici
echo =======================================================
echo.
...
if not exist "C:\etsy_temp\WovenLoomRugs" mkdir "C:\etsy_temp\WovenLoomRugs"
echo [OK] Klasor hazir: C:\etsy_temp\WovenLoomRugs

if not exist "C:\etsy_temp\WovenLoomRugs_INDIR.bat" (
  (
    echo @echo off
    echo title WovenLoomRugs - Otomasyon
    echo call "C:\rugskilim-panel\vds\WOVENLOOMRUGS_KUR_VE_BASLAT.bat"
  ) > "C:\etsy_temp\WovenLoomRugs_INDIR.bat"
  echo [OK] INDIR.bat olusturuldu: C:\etsy_temp\WovenLoomRugs_INDIR.bat
)

REM ── .env kontrol ─────────────────────────────────────────
if not exist "C:\rugskilim-panel\vds\.env" (
  copy "C:\rugskilim-panel\vds\WOVENLOOMRUGS_env.txt" "C:\rugskilim-panel\vds\.env" >nul
