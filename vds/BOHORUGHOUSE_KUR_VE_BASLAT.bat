@echo off
setlocal
title BohoRugHouse - Kurulum ve Baslatici

echo =======================================================
echo   BohoRugHouse - Otomatik Kurulum ve Baslatici
echo =======================================================
echo.
...
if not exist "C:\etsy_temp\BohoRugHouse" mkdir "C:\etsy_temp\BohoRugHouse"
echo [OK] Klasor hazir: C:\etsy_temp\BohoRugHouse

if not exist "C:\etsy_temp\BohoRugHouse_INDIR.bat" (
  (
    echo @echo off
    echo title BohoRugHouse - Otomasyon
    echo call "C:\rugskilim-panel\vds\BOHORUGHOUSE_KUR_VE_BASLAT.bat"
  ) > "C:\etsy_temp\BohoRugHouse_INDIR.bat"
  echo [OK] INDIR.bat olusturuldu: C:\etsy_temp\BohoRugHouse_INDIR.bat
)

REM ── .env kontrol ─────────────────────────────────────────
if not exist "C:\rugskilim-panel\vds\.env" (
  copy "C:\rugskilim-panel\vds\BOHORUGHOUSE_env.txt" "C:\rugskilim-panel\vds\.env" >nul
