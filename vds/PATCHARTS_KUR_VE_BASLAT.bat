@echo off
setlocal
title PatchArts - Kurulum ve Baslatici

echo =======================================================
echo   PatchArts - Otomatik Kurulum ve Baslatici
echo =======================================================
echo.
...
if not exist "C:\etsy_temp\PatchArts" mkdir "C:\etsy_temp\PatchArts"
echo [OK] Klasor hazir: C:\etsy_temp\PatchArts

if not exist "C:\etsy_temp\PatchArts_INDIR.bat" (
  (
    echo @echo off
    echo title PatchArts - Otomasyon
    echo call "C:\rugskilim-panel\vds\PATCHARTS_KUR_VE_BASLAT.bat"
  ) > "C:\etsy_temp\PatchArts_INDIR.bat"
  echo [OK] INDIR.bat olusturuldu: C:\etsy_temp\PatchArts_INDIR.bat
)

REM ── .env kontrol ─────────────────────────────────────────
if not exist "C:\rugskilim-panel\vds\.env" (
  copy "C:\rugskilim-panel\vds\PATCHARTS_env.txt" "C:\rugskilim-panel\vds\.env" >nul
