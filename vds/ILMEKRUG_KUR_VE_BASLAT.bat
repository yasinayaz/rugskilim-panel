@echo off
setlocal
title IlmekRug - Kurulum ve Baslatici

echo =======================================================
echo   IlmekRug - Otomatik Kurulum ve Baslatici
echo =======================================================
echo.
...
if not exist "C:\etsy_temp\IlmekRug" mkdir "C:\etsy_temp\IlmekRug"
echo [OK] Klasor hazir: C:\etsy_temp\IlmekRug

if not exist "C:\etsy_temp\IlmekRug_INDIR.bat" (
  (
    echo @echo off
    echo title IlmekRug - Otomasyon
    echo call "C:\rugskilim-panel\vds\ILMEKRUG_KUR_VE_BASLAT.bat"
  ) > "C:\etsy_temp\IlmekRug_INDIR.bat"
  echo [OK] INDIR.bat olusturuldu: C:\etsy_temp\IlmekRug_INDIR.bat
)

REM ── .env kontrol ─────────────────────────────────────────
if not exist "C:\rugskilim-panel\vds\.env" (
  copy "C:\rugskilim-panel\vds\ILMEKRUG_env.txt" "C:\rugskilim-panel\vds\.env" >nul
