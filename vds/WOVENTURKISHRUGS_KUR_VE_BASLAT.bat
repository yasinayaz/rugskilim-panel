@echo off
setlocal
title WovenTurkishRugs - Kurulum ve Baslatici

echo =======================================================
echo   WovenTurkishRugs - Otomatik Kurulum ve Baslatici
echo =======================================================
echo.
...
if not exist "C:\etsy_temp\WovenTurkishRugs" mkdir "C:\etsy_temp\WovenTurkishRugs"
echo [OK] Klasor hazir: C:\etsy_temp\WovenTurkishRugs

if not exist "C:\etsy_temp\WovenTurkishRugs_INDIR.bat" (
  (
    echo @echo off
    echo title WovenTurkishRugs - Otomasyon
    echo call "C:\rugskilim-panel\vds\WOVENTURKISHRUGS_KUR_VE_BASLAT.bat"
  ) > "C:\etsy_temp\WovenTurkishRugs_INDIR.bat"
  echo [OK] INDIR.bat olusturuldu: C:\etsy_temp\WovenTurkishRugs_INDIR.bat
)

REM ── .env kontrol ─────────────────────────────────────────
if not exist "C:\rugskilim-panel\vds\.env" (
  copy "C:\rugskilim-panel\vds\WOVENTURKISHRUGS_env.txt" "C:\rugskilim-panel\vds\.env" >nul
...
set "TEMP_DIR=C:\etsy_temp\WovenTurkishRugs"
